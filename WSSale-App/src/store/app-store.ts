...
type PortalKey = 'dashboard' | 'sales' | 'trip-board' | 'quotation' | 'store' | 'papertrail' | 'rebate' | 'rebate-plan' | 'cn-rebate' | 'control-ticket' | 'accounting' | 'recon' | 'giveaway' | 'aging' | 'reports' | 'scale-reports' | 'truckscale' | 'weigh-inbox' | 'policy' | 'governance' | 'ops' | 'admin' | 'org' | 'master' | 'profile' | 'incentive-report' | 'budget-report';
