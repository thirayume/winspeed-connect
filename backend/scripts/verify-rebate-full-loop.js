...
async function main() {
  ...
  //
  // เดิมใช้ emp-00036 (คุณEMP-00036) เพราะเคยถูกผูกกับภาค 05 — ซึ่งเป็นการผูกที่ผิด
  // ยอดขายของเขาอยู่ภาค 03 และถูกแก้แล้วเมื่อ 4 ส.ค. 2569 ภาค 05 เป็นของEMP-00024
  //
