...
-- Ensure SOHD records with clearflag = 'Y' or WeighOutWeight IS NOT NULL are properly evaluated as SHIPPED status.
...
PRINT '✓ WF migration 058 complete (fixed clearflag = Y SHIPPED status evaluation)';
GO
