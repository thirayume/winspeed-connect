-- 063_fix_winspeed_approval.sql
-- Update sp_ConfirmSalesOrder to insert into SOHD as Approved ('Y') instead of Draft ('N')
-- This prevents the "double confirmation" requirement and stops WinSpeed from overwriting the status
-- when a user confirms it manually.
...
BEGIN
    ...
    BEGIN TRY
        ...
        VALUES (
            @NewSoid, @DocuNo, @CustId, @CustName, CAST(GETDATE() AS DATE), @TotalAmnt, 'Y', 'N', 'N', @EmpID, '1',
            '103', 'N', 0, '3', '1', 1, 'N', 'N', 'Y', 'N',
