...
const USERS = [
  ...
  { username: 'sales1',      password: 'Sales@2026',     displayName: 'EMP-00035 (พนักงานขาย)',    role: 'SALES',      empId: '4000' },
  { username: 'sales2',      password: 'Sales@2026',     displayName: 'EMP-00036 (พนักงานขาย)',      role: 'SALES',      empId: '4001' },
  { username: 'surachai',    password: 'Approve@2026',   displayName: 'EMP-00019 (อนุมัติปลดล็อก)', role: 'APPROVER',   empId: null },
