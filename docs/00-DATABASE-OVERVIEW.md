...
6. [Data Dictionary — TruckScale (MySQL, READ-ONLY)](#6-data-dictionary--truckscale-mysql-read-only)
...
## 6. Data Dictionary — TruckScale (MySQL, READ-ONLY)
...
**หน่วย:** TruckScale = **กิโลกรัม** (kg) · App แปลงเป็นตัน (÷1000) เมื่อแสดง · ความจุเครื่องชั่ง 80,000 kg/เครื่อง (2 เครื่อง)
...
---
*เอกสารถัดไป: [01-PAGES-SQL-MAP.md](01-PAGES-SQL-MAP.md) · [02-TEST-CASES.md](02-TEST-CASES.md) · [03-USER-GUIDE.md](03-USER-GUIDE.md) · [04-SOP.md](04-SOP.md)*
