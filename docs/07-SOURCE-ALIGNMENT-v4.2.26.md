...
| 6 | Customer filters by sales/area/group/employee | Implemented in code | Dynamic `dbo.EMCust` column detection in `/master/customer-filters` and `/master/customers` | Needs DB column validation |
