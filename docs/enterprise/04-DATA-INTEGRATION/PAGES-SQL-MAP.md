---
documentId: "WF-DATA-011"
title: "01 — แผนที่หน้า → API → SQL → Migration (Pages / SQL / Migration Map)"
version: "v1.0"
status: Released
...
> Document ID: `WF-DATA-011` · Version: v1.0 · Date: 21 กรกฎาคม 2569 (21 July 2026) · Status: Released
...
Automated QA note: root scripts `smoke:queries` and `smoke:api:local` validate the current SQL/API map against the restored local database. See [09-AUTOMATED-QA.md](../06-QUALITY-OPERATIONS/AUTOMATED-QA.md).
