...
- **ที่ผูกไว้เดิมผิด** — `emp-00036` มนัส ถูกผูกกับภาคใต้ ทั้งที่ยอดขาย 16,848 ใบอยู่ภาคอีสาน และไม่มีทางแก้จากระบบเลย · แต่งตั้งใหม่ครบทั้ง 7 ภาคจากสายบังคับบัญชาจริงใน `dbo.EMEmp.EmpHead` ไม่ใช่จากผู้ที่ทำยอดสูงสุด เพราะผู้ทำยอดสูงสุดเป็นเพื่อนร่วมงานระดับเดียวกับผู้ยื่นเรื่อง
- **บริษัทไม่มีฝ่ายการตลาด** — `dbo.EMPost` มี 10 ตำแหน่งและไม่มีตำแหน่งใดเกี่ยวกับการตลาด · ใช้กรรมการบริหารสองคนที่มีจริงเป็นชั้น 3 และ 4 แทน (`emp-00016` เกศ · `emp-00059` ไทยาณี เลื่อนเป็น `C_LEVEL`)
