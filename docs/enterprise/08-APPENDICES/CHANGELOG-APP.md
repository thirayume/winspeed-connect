...
- รอยเดินเอกสารต่อเนื่องข้ามระบบใน `dbo.SMAudit` — `990000001 wf:emp-00035` (แอปสร้าง) → `2098003080 MATA` (WINSpeed อนุมัติ)
...
ตรวจกับฐาน UAT แล้ว — `I69-02420` มีรอยต่อเนื่อง: WINSpeed สร้างเมื่อ 12 ส.ค. (หน้าจอ 2098003048 ผู้ใช้ `mata`) → แอปจัดสินค้าและชั่งออกเมื่อ 19 ส.ค. (หน้าจอ 990000002/990000004 ผู้ใช้ `wf:admin`)
