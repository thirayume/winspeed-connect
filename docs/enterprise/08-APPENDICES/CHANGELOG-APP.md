...
> **หมายเหตุ:** เวอร์ชันปัจจุบัน = **1.6.8** · รายการ `[v5.x]` ด้านล่างเป็น**ประวัติ build ภายในก่อน reset** (คงไว้เพื่อ traceability ตาม ISO — ไม่ลบ)
>
...
**แก้ความเข้าใจผิดเรื่องเส้นทางใบแจ้งหนี้** — Post Invoice (WF) เป็นหน้าจอเฉพาะทางที่ดึงจาก
`WFRedemtionHD` (ใบเบิกตั๋วปุ๋ย) ไม่ใช่ทางออกใบแจ้งหนี้ปกติ · ทางที่ถูกคือเมนู **Credit Sale**
ใส่ใบส่งของในช่อง `Ref. SO No.`
