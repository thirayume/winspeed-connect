...
- **พบว่าปลายทางของกระดาษคือ `dbo.SOInvHD` Docutype 106** เลขที่ `RB<รหัสผู้ขอ><ปี พ.ศ.>-<ลำดับ>` · 16,195 ใบ · ยืนยันกับใบกระดาษ `RBD68-049` ตรงทุกช่อง (วันที่ 7/05/2568 · CUST-23037 · 55,800 บาท)
