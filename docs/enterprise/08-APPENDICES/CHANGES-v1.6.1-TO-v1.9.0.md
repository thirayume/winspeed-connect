...
> **วิธีใช้เอกสารนี้**
> ชุดเอกสาร v1.0 **ไม่ถูกแก้ในที่เดิม** ตามกติกาควบคุมเอกสาร
> (ตั้งแต่ 3 ก.ย. 2569 ทั้งสองชุดรวมอยู่ใน `docs/enterprise/` ใต้ pipeline เดียวกันแล้ว)
