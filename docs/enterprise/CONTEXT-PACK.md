...
| # | งาน | สถานะ |
|---|---|---|
| 1 | ผูกผู้ใช้เข้ากับตำแหน่ง | 🟡 **41/41 บันทึกแล้ว 5 ก.ย. 2569** · หาผู้อนุมัติได้ 36 คน · เหลือ **`AMD-MKT` และ `EXEC-SALE` ยังไม่มีคนถือ** ทำให้ผู้จัดการอาวุโส 3 คนไม่มีผู้อนุมัติเหนือขึ้นไป |
