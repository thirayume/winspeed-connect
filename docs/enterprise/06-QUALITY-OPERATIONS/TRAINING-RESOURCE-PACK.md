...
| Status | Approved — ห้ามใช้ประกาศ competency อย่างเป็นทางการก่อน Process Owner ตรวจรับ |
...
![หน้าขาย](../05-UI-SCREENSHOTS/generated/sales--sales.png)
...
![หน้า Paper Trail](../05-UI-SCREENSHOTS/generated/manager--papertrail.png)
