...
> Document ID: `WF-QA-010` · Version: v1.0 · Date: 21 กรกฎาคม 2569 (21 July 2026) · Status: Released
...
> สำหรับ UAT / Regression / ISO 9001 · build v5.0.0
...
## วิธีเตรียมทดสอบ
1. เข้าระบบด้วย user ตาม Role ที่ระบุ (ดู [03-USER-GUIDE.md](USER-GUIDE-DETAIL.md))
...
Detailed automated steps and latest measured results are maintained in [09-AUTOMATED-QA.md](AUTOMATED-QA.md).
