...
> Document ID: `WF-SEC-012` · Version: v1.0 · Date: 21 กรกฎาคม 2569 (21 July 2026) · Status: Released
...
- เปลี่ยนรหัสผ่านทุกตัว (ดู [SECURITY.md](SECURITY-OPERATIONS.md)) · `CORS_ORIGIN` = domain จริง
