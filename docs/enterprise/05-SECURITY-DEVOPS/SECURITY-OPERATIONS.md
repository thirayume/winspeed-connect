---
documentId: "WF-SEC-010"
title: "SECURITY — การจัดการความปลอดภัย & การเปลี่ยนรหัสผ่าน (P0-1)"
version: "v1.0"
status: Released
...
> Document ID: `WF-SEC-010` · Version: v1.0 · Date: 21 กรกฎาคม 2569 (21 July 2026) · Status: Released
...
### 2. MySQL (TruckScale)
- [ ] เปลี่ยนรหัส `root`
- [ ] **แนะนำ:** สร้าง user `truckscale_bridge` ที่ SELECT เฉพาะตารางชั่ง/อ้างอิง และ INSERT/DELETE เฉพาะ `tbl_keyone` (ห้าม UPDATE/DDL และห้ามสิทธิ์ตารางอื่น)
