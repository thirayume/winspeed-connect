...
1. สร้าง **`admin` / `***REMOVED-PASSWORD***`** (role ADMIN) — ⚠️ `W0rld` ใช้ **เลขศูนย์** ไม่ใช่ตัว O
...
> รหัสเริ่มต้นของพนักงานทุกคนคือ `***REMOVED-PASSWORD***` เช่นกัน — **ต้องบังคับเปลี่ยนก่อนใช้งานจริง**
